...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnOpenSettings,
      @NonNull SeekBar seekSpeed, @NonNull TextView tvHint, @NonNull TextView tvSpeed) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnOpenSettings, seekSpeed,
          tvHint, tvSpeed);
    }
